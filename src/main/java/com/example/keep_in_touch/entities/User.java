 ...
 * This class represents a user in the personal contact manager application.
...
@NotBlank(message = "Name field is required") //It is mandatory (cannot be blank) and must be between 2 and 20 characters long.
